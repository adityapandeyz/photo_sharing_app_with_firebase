...
import 'package:photo_sharing_app_with_firebase/search_post/user.dart';
import 'package:photo_sharing_app_with_firebase/search_post/users_design_widget.dart';

class SearchPost extends StatefulWidget {
  const SearchPost({Key? key}) : super(key: key);

  @override
  State<SearchPost> createState() => _SeachPostState();
}

Future<QuerySnapshot>? postDocumentsList;
String userNameText = "";

class _SeachPostState extends State<SearchPost> {
